...
const validate = combineValidators({
  ...
  description: composeValidators(isRequired({message: 'Please enter a desciption'}), hasLengthGreaterThan(4)({message: 'Description needs to be atleast 5 characters'}))(),
